	...
	<center>
		...
		<table width="100%" border="3" align="center">
			<tr align="center">
				...
				<td align="center" width="70">보험적용여부</td>
				<td align="center" width="70">무선WIFI적용여부</td>
				<td align="center" width="70">네비적용여부</td>
				<td align="center" width="70">베이비시트적용여부</td>
	...
	<c:forEach var="vo" items="${requestScope.v}" >
			<tr align="center">
				...
				<td align="center" width="100">
					<a href="${contextPath}/car/update.do?orderid=${vo.orderid}&carimg=${vo.carimg}">
						예약수정
					</a>
				</td>
				<td align="center" width="100">
					<a href="${contextPath}/car/delete.do?orderid=${vo.orderid}&center=Delete.jsp&memberphone=${requestScope.memberphone}">
						예약취소
					</a>
				</td>					
			</tr>			
