...
<%
	...
	String carimg = vo.getCarimg(); //예약한 차랑 이미지명
	int carreserveday = vo.getCarreserveday();//예약한 대여기간
	String carbegindate = vo.getCarbegindate();//예약한 대여 시작 날짜
	int carins = vo.getCarins();//예약한 보험적용여부값
	int carwifi = vo.getCarwifi(); 
	int carbabyseat = vo.getCarbabyseat();
	int carnave = vo.getCarnave();	
	int carqty = vo.getCarqty();//대여 수량
	
	String memberphone = (String)request.getAttribute("memberphone"); //휴대폰번호 
%>	

<!-- 	UPDATE 테이블명 SET 수정할열명1=수정할값1,  수정할열명2=수정할값2 -->
<!-- 	WHERE 조건열명 = 조건값; -->
			...
			<table width="1000">
				...
				<tr>
					<td align="center" width="200" colspan="2">
						...
						<input type="submit" value="예약정보수정">
					</td>
				</tr>				
			</table>
		</form>
