...
//검색결과 확인
//1. 이클립스에서 톰캣 서버를 재시작합니다.
//2. 웹브라우저 주소창에 다음 주소를 입력하여 접속합니다.
//   http://localhost:8090/CarProject_/NaverSearchAPI.do
//검색어 키워드를 주소 옆에 ?를 적어주지 않아 500에러가 발생할겁니다. 

//3. 다음처럼 주소입력후 옆에 키워드를 입력해서 요청 접속 합니다.
// http://localhost:8090/CarProject_/NaverSearchAPI.do?keyword=강남역맛집&startNum=1
